...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-surface font-sans text-on-surface overflow-x-hidden">
      ...
      {/* Navbar */}
      <nav className="flex items-center justify-between p-4 max-w-5xl mx-auto animate-fade-in">
      ...
      <header className="px-4 pt-12 pb-20 text-center max-w-5xl mx-auto flex flex-col items-center">
        <h1 className="text-4xl md:text-6xl font-extrabold text-on-surface mb-4 leading-tight opacity-0 animate-slide-up">
          Chega de enrolar com os deveres 📚
        </h1>
        <p className="text-lg md:text-xl text-on-surface-variant mb-8 max-w-2xl opacity-0 animate-slide-up-delay-1">
          Organize suas tarefas, prove que terminou tirando uma foto e acumule XP para manter sua ofensiva!
        </p>
        <button 
          onClick={() => navigate('/login')}
          className="bg-primary text-white font-bold py-4 px-8 rounded-full shadow-lg shadow-primary/30 hover:shadow-primary/50 hover:-translate-y-1 transition-all text-lg mb-10 opacity-0 animate-slide-up-delay-2"
        >
          Começar agora — é grátis ✨
        </button>
        
        {/* Mockup / Badge */}
        <div className="relative w-full max-w-xs md:max-w-md mx-auto opacity-0 animate-slide-up-delay-2">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 relative">
            ...
            <div className="flex-1 flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-primary text-white flex items-center justify-center text-2xl font-bold mb-6 border-4 border-surface shadow-md">1</div>
            ...
            <div className="flex-1 flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-primary text-white flex items-center justify-center text-2xl font-bold mb-6 border-4 border-surface shadow-md">2</div>
            ...
            <div className="flex-1 flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-secondary text-white flex items-center justify-center text-2xl font-bold mb-6 border-4 border-surface shadow-md">3</div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden transition-all">
                <button 
